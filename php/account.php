...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../forntend/css/profil-edit.css">
    ...
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <form class="d-inline-flex flex-fill justify-content-center align-items-center searchbar" method="post" enctype="multipart/form-data">
      ...
      <div class="images-header">
        ...
        <div id="upload-profile-image">
          <label for="image-input">
            <img class="upload-image" src="../forntend/img/editphoto_white.png"/>
          </label>
      ...
      <div class="row">
        <div class="col-3">
          ...
          <div class="sidebar activities"><span class="">Aktivitas</span> 
            ...
            <div class="items user-ratings"><a href="profil-penilaian.html">Penilaian</a></div>
            <div class="items last user-reviews"><a href="profilulasan.php?id=<?= $id; ?>">Ulasan</a></div>           
          </div>
        ...
        <div class="col-8 form information">
          <div class="row title">
            <div class="col-auto me-auto"><h4>Informasi Pribadi</h4></div>
            <div class="col-auto"><a href="#" id="edit-info" type="button" class="btn btn-danger"><i class="bi bi-pencil-square"></i></a></div>
          </div>
          <form action="" class="row private-info">
          ...
          <a href="#" id="save-info" type="button" name="submit" class="btn btn-danger float-end">Simpan Informasi</a>
        </div>

        <div class="col-3 empty"></div>

        <div class="col-8 form password-change">  
          <div class="row title">
            <div class="col-auto me-auto"><h4>Ganti Password</h4></div>
            <div class="col-auto"><a href="#" id="edit-password" type="button" class="btn btn-danger">
              <i class="bi bi-pencil-square"></i></a></div>
          </div>          
          <form action="" class="row password">
            <div class="col-10 mb-3">
          ...
          <a href="#" id="save-button" type="submit" name="submit1" class="btn btn-danger float-end">Simpan Password</a>
          <script>
