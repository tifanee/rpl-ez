...
<body>
  ...
  <div class="container mt-5 pt-5" id="item-cards">
    <div class="main-title">
      <p style="font-size: 22px; font-weight:550px; text-decoration:underline; color: #DD3131;">
        ...
        <div class="column">
          <div class="col-md card-items">
            ...
            <div class="d-flex justify-content-center">
              <figure class="card card-product-grid card-lg"> <a href="info2.php?id=<?= $id; ?>&idr=<?= $idr; ?>" class="img-wrap" data-abc="true"> <img src="../database/img/resto/<?= $resto['foto_resto']; ?>"> </a>
                ...
                <div class="bottom-wrap">
                  <a href="info2.php?id=<?= $id; ?>&idr=<?= $idr; ?>" class="review">Tulis review...</a>
                </div>
              </figure>
            </div>
          </div>
