...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../frontend/css/category-loggedout.css">
...
<body>
  ...
  <div class="container-fluid" id="NavBar">
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-light">
        <a class="navbar-brand toplogo" href="../index.php"><img src="../frontend/img/logo ezeats red.png"
            alt="EzEats"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav ms-auto">
            ...
            <a class="nav-link" id="SignUp"  name="signup" href="signup.php?location=<?= urlencode($_SERVER['REQUEST_URI']); ?>">Daftar</a>
            <a class="btn btn-danger" id="SignIn" name="login" href="login.php?location=<?= urlencode($_SERVER['REQUEST_URI']); ?>" role="button">Masuk</a>
          </div>
        </div>
      </nav>
    </div>
  ...
  <div id="carouselBanner" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      ...
      <div class="banner text-center"><img src="../frontend/img/logo ezeats white_glow.png" alt="EzEats Logo"></div>
    </div>
  </div>
