...
<html lang="id">
  ...
  <body>
    ...
    <div class="container-fluid" id="NavBar">
      <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
          <a class="navbar-brand toplogo" href="#"><img src="http://localhost/ezeats/frontend/img/ezeatsred.png" alt="EzEats" width="120" height="70"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup" >
              <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link" id="Photo" href="#"><img src="http://localhost/ezeats/images/<?= $user["gambar"];?>" width="50" height="50"></a>
                  ...
                  <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li><a class="dropdown-item exit" href="logout.php" name="logout">Keluar</a></li>                      
                      </ul>
                    </li>
                  </ul>
                </div>
    ...
    <!--Cover-->
    <div class="jumbotron jumbotron-fluid" style="background-image: url('http://localhost/ezeats/frontend/img/begron.png'); ">
      <div class="container" >
        <div class="text-center">
          <img id="logoEzEats" src="http://localhost/ezeats/frontend/img/logo.png" class="rounded" alt="EzEats Logo" width="300" height="200">
        </div>
      </div>      
    </div>
    <!--Search Box-->
      ...
      <div class="row">
        <div class="col-md card-items">
            ...
            <div class="d-flex justify-content-center">
                <figure class="card card-product-grid card-lg"> <a href="#" class="img-wrap" data-abc="true"> <img src="http://localhost/ezeats/frontend/img/mcd.png"> </a>
